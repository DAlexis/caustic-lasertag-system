...
public class RCSP {
    ...
    public interface OperationDispatcher {
         ...
         */
        boolean dispatchOperation(DeviceAddress address, RCSPOperation operation);
    }
    ...
    public interface OperationDispatcherUser {
        void addOperationDispatcher(int code, OperationDispatcher disp);
        void addOperationDispatcher(OperationDispatcher disp);
    }
    // Descriptions
    ...
    public static class Operations {
        ...
        public static void init() {
            ...
            try {
                ...
                Class.forName(AnyDevice.class.getName());
                Class.forName(AnyDevice.Configuration.class.getName());
                Class.forName(AnyDevice.Functions.class.getName());
                Class.forName(Rifle.class.getName());
                Class.forName(Rifle.Configuration.class.getName());
                Class.forName(Rifle.Functions.class.getName());
                Class.forName(HeadSensor.class.getName());
                Class.forName(HeadSensor.Configuration.class.getName());
