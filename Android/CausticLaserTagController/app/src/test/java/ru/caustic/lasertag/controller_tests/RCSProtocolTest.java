...
public class RCSProtocolTest extends TestCase {
    ...
    public void testStreamReadWriteOneParameter() {
        ...
        int size = pars.serializeOneParameter(25, arr, 0, 20);
    ...
    public void testStreamSerDeserStream() {
        ...
        int cursor = 0;
        cursor += pars.serializeOneParameter(1, arr, cursor, bufferSize);
        cursor += pars.serializeOneParameter(2, arr, cursor, bufferSize);
        cursor += pars.serializeOneParameter(3, arr, cursor, bufferSize);
        cursor += pars.serializeOneParameter(4, arr, cursor, bufferSize);
